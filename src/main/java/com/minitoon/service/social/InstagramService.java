...
import com.minitoon.service.CloudConvertService;
 ...
 * Uses container-based upload flow with CloudConvert public URLs
 */
@Slf4j
@Service
...
public class InstagramService {
    ...
    public String uploadReel(String videoPath, String caption, String coverImagePath) {
        ...
        try {
            // Upload video to CloudConvert to get public URL
            String videoUrl = cloudConvertService.uploadAndGetPublicUrl(videoPath);
            String coverUrl = coverImagePath != null ? 
                    cloudConvertService.uploadAndGetPublicUrl(coverImagePath) : null;

            String containerId = createReelContainer(videoUrl, caption, coverUrl);
    ...
    private String createReelContainer(String videoUrl, String caption, String coverUrl) {
        ...
        try {
            ...
            if (coverUrl != null) {
                requestBody.put("cover_url", coverUrl);
            }
            ...
            if (response == null || !response.has("id")) {
                throw new SocialUploadException("Instagram", videoUrl, "Failed to create container", null);
            }

            return response.path("id").asText();

        } catch (Exception e) {
            throw new SocialUploadException("Instagram", videoUrl, "Container failed: " + e.getMessage(), e);
        }
    }
